...
public class PersonExamActivity extends AppCompatActivity {
    ...
    private void initView(){
        ...
        dataBaseHelper = new DataBaseHelper(PersonExamActivity.this, AppConstants.SQL_VISION);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(PersonExamActivity.this));
        ...
        button.setOnClickListener(v -> {
            LayoutInflater factory = LayoutInflater.from(PersonExamActivity.this);//提示框
